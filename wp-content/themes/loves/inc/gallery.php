	...
	<div class="gallery">
		...
		<div class="content">
			...
			<div class="view col-md-8 col-md-offset-2">
				<div class="main-view">
					<img src="../wp-content/themes/loves/assets/images/dogs2.jpg" alt="Tokata">
				</div>
				<div class="sub-view">
					<div class="col-md-2 col-md-offset-1" style="padding-left: 0">
						<img src="../wp-content/themes/loves/assets/images/turtle2.jpg" alt="Tokata 1">
					</div>
					<div class="col-md-2" style="padding-left: 0">
						<img src="../wp-content/themes/loves/assets/images/butterfly2.jpg" alt="Tokata 2">
					</div>
					<div class="col-md-2" style="padding-left: 0">
						<img src="../wp-content/themes/loves/assets/images/dogs3.jpg" alt="Tokata 3">
					</div>
					<div class="col-md-2" style="padding-left: 0">
						<img src="../wp-content/themes/loves/assets/images/owl2.jpg" alt="Tokata 4">
					</div>
					<div class="col-md-2" style="padding-left: 0">
						<img src="../wp-content/themes/loves/assets/images/cat2.jpg" alt="Tokata 5">
					</div>
				</div>
			</div>
		</div>
